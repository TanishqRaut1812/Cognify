    ...
    async function loadCurrentTestPrep() {
        ...
        try {
            ...
            if (data.categories && data.categories.length > 0) {
                ...
                html += `<div style="color: var(--text-muted); margin-bottom: 16px;">No syllabus topics published yet for this test.</div>`;
            }
            ...
            if (data.resources && data.resources.notes) {
                ...
                html += `
                    <span class="resource-pill disabled">
                        <i data-lucide="info"></i> No Notes Uploaded
                    </span>
                `;
            }
            ...
            if (data.resources && data.resources.practice) {
                ...
                html += `
                    <span class="resource-pill disabled">
                        <i data-lucide="info"></i> No Practice Questions
                    </span>
                `;
            }
                ...
                html += `
                    <div class="plan-card">
                        ...
                        <div class="resource-pills margin-top-sm">
                            ${t.notes ? `<a href="${t.notes.file_path}" target="_blank" class="resource-pill"><i data-lucide="file-text"></i> Notes</a>` : `<span class="resource-pill disabled">No Notes</span>`}
                            ${t.practice ? `<a href="${t.practice.file_path}" target="_blank" class="resource-pill"><i data-lucide="help-circle"></i> Practice</a>` : `<span class="resource-pill disabled">No Practice</span>`}
                            
                            ${t.status === 'Completed' ? (
                                `${t.question_paper ? `<a href="${t.question_paper.file_path}" target="_blank" class="resource-pill" style="border-color: var(--accent-primary);"><i data-lucide="file-check"></i> Question Paper</a>` : `<span class="resource-pill disabled">No Question Paper</span>`}
                                 ${t.answer_key ? `<a href="${t.answer_key.file_path}" target="_blank" class="resource-pill" style="border-color: var(--accent-emerald);"><i data-lucide="key"></i> Answer Key</a>` : `<span class="resource-pill disabled">No Answer Key</span>`}`
                            ) : ''}
                        </div>
                    </div>
                `;
            ...
            html += `
                <div class="plan-card">
                    ...
                    <div class="resource-pills margin-top-sm">
                        ...
                        ${t.status === 'Completed' ? (
                            `${t.question_paper ? `<a href="${t.question_paper.file_path}" target="_blank" class="resource-pill"><i data-lucide="file-check"></i> Paper</a>` : `<span class="resource-pill disabled">No Paper</span>`}
                             ${t.answer_key ? `<a href="${t.answer_key.file_path}" target="_blank" class="resource-pill"><i data-lucide="key"></i> Key</a>` : `<span class="resource-pill disabled">No Key</span>`}`
                        ) : ''}
                    </div>
                </div>
            `;
