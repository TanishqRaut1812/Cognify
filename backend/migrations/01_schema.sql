-- Cognify Production PostgreSQL Schema Migration (01_schema.sql)

-- DROP EXISTING TABLES IN REVERSE DEPENDENCY ORDER TO RECREATE CLEAN PRODUCTION SCHEMA
...
-- AUTO-SYNC TRIGGER FOR REGISTRATION AND ROLL NUMBERS
...
-- AUTO-SYNC TRIGGER FOR QUESTIONS
